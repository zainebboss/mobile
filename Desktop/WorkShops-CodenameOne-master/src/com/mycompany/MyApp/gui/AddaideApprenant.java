 ...
 * @author nidha
 */
public class AddaideApprenant extends Form {
    ...
    */
    ...
    Form current;
    public AddaideApprenant(Resources res) {  
        ...
        TextField subject = new TextField("","entrer sujet");
        subject.setUIID("TextFiealdBlack");
        addStringValue("sujet",subject);
        
        TextField probleme = new TextField("","entrer probleme");
        probleme.setUIID("TextFiealdBlack");
        addStringValue("probleme",probleme);
        
        TextField mail = new TextField("","entrer mail");
        mail.setUIID("TextFiealdBlack");
        ...
        btnAjout.addActionListener((e) -> {
            try {
                if(subject.getText()==""||probleme.getText()==""||mail.getText()=="") {
                    ...
                    Aide aide = new Aide();
                    aide.setSujet(subject.getText().toString());
                    aide.setProbleme(probleme.getText().toString());
                    aide.setMail(mail.getText().toString());
...
//                    subject.setId_teacher(Integer.parseInt(idTeacher.getText().toString()));
                    ...
                    ServiceAide.getInstance().addAIde(aide);
